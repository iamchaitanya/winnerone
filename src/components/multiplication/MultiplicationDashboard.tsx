...
export const MultiplicationDashboard: React.FC<MultiplicationDashboardProps> = ({
    ...
    const leader = isAyaanLeading
        ? { name: 'Ayaan', total: ayaanTotal, color: 'violet', icon: User }
        : { name: 'Riyaan', total: riyaanTotal, color: 'purple', icon: Users };
