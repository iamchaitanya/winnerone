...
import { ArrowLeft, Crown, IndianRupee, History, ChevronDown, ChevronRight, User, Users, BookOpen } from 'lucide-react';
...
interface WordPowerDashboardProps {
    ayaanTotal: number;
    riyaanTotal: number;
...
export const WordPowerDashboard: React.FC<WordPowerDashboardProps> = ({
    ayaanTotal,
    riyaanTotal,
    groupedHistory,
    onBack
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 animate-in slide-in-from-right duration-300 overflow-x-hidden">
            <div className="max-w-2xl mx-auto w-full">
                <header className="flex items-center gap-4 mb-8">
                    ...
                    <h1 className="text-xl font-bold text-slate-900 dark:text-white">Word Power Dashboard</h1>
                </header>
                                                ...
                                                <tr>
                                                    <td colSpan={3} className="px-5 py-16 text-center">
                                                        <div className="flex flex-col items-center gap-2">
                                                            <BookOpen size={32} className="text-slate-200 dark:text-slate-800" />
