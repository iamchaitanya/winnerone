...
export const DivideResults: React.FC<DivideResultsProps> = ({
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col items-center justify-center p-6 animate-in zoom-in-95 duration-500 text-center">
            <div className={`w-24 h-24 rounded-full flex items-center justify-center mb-6 ${finalSessionEarnings >= 0 ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-600' : 'bg-rose-100 dark:bg-rose-900/30 text-rose-600'}`}>
                <IndianRupee size={64} />
            </div>
            ...
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-10">+₹3 correct · −₹3 wrong</p>
