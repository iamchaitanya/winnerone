...
import { DivQuestion } from '../../hooks/useDivideEngine';

interface DivideQuizProps {
    currentQ: DivQuestion | undefined;
    currentIndex: number;
    timeLeft: number;
    score: number;
    displayInput: string;
...
export const DivideQuiz: React.FC<DivideQuizProps> = ({
    currentQ, currentIndex, timeLeft, score, displayInput, onKeyClick
}) => {
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col p-6 animate-in slide-in-from-right duration-300">
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
                <span className="mb-4 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-sky-100 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400">
                    Division
                </span>
