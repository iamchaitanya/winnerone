...
export const DivideDashboard: React.FC<DivideDashboardProps> = ({
    ayaanTotal,
    riyaanTotal,
    groupedHistory,
    onBack
    ...
    const leader = isAyaanLeading
        ? { name: 'Ayaan', total: ayaanTotal, color: 'sky', icon: User }
        : { name: 'Riyaan', total: riyaanTotal, color: 'blue', icon: Users };
