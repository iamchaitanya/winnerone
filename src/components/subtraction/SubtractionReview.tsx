...
interface SubtractionReviewProps {
    sessionResults: QuestionResult[];
    onBack: () => void;
}

export const SubtractionReview: React.FC<SubtractionReviewProps> = ({ sessionResults, onBack }) => {
    return (
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                            {sessionResults.length > 0 ? (
                                sessionResults.map((res, idx) => (
                                    ...
                                    >
                                        <td className="px-4 py-5 text-[11px] font-bold text-slate-400 tabular-nums">{idx + 1}</td>
