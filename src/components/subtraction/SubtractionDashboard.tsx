...
interface SubtractionDashboardProps {
    ayaanTotal: number;
    riyaanTotal: number;
    groupedHistory: any[];
    onBack: () => void;
...
export const SubtractionDashboard: React.FC<SubtractionDashboardProps> = ({
    ayaanTotal,
    riyaanTotal,
    groupedHistory,
    onBack
    ...
    const leader = isAyaanLeading
        ? { name: 'Ayaan', total: ayaanTotal, color: 'orange', icon: User }
        : { name: 'Riyaan', total: riyaanTotal, color: 'amber', icon: Users };
