...
export const SubtractionQuiz: React.FC<SubtractionQuizProps> = ({
    currentQ,
    currentIndex,
    timeLeft,
    score,
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col p-6 animate-in slide-in-from-right duration-300">
            ...
            <div className="mt-8 grid grid-cols-3 gap-3 mb-6 max-w-xs mx-auto w-full">
                ...
                <button
                    onClick={() => onKeyClick('-')}
                    className="h-16 bg-orange-50 dark:bg-orange-900/30 text-2xl font-black text-orange-600 dark:text-orange-400 rounded-2xl active:bg-orange-100 shadow-sm transition-transform active:scale-95"
                >
                    −
                </button>
                <button
