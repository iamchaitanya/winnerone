...
export const MultiplyDashboard: React.FC<MultiplyDashboardProps> = ({
    ayaanTotal,
    riyaanTotal,
    groupedHistory,
    onBack
    ...
    const leader = isAyaanLeading
        ? { name: 'Ayaan', total: ayaanTotal, color: 'pink', icon: User }
        : { name: 'Riyaan', total: riyaanTotal, color: 'fuchsia', icon: Users };
